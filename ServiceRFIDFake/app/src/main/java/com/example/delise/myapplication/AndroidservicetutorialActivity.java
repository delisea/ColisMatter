    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      Message msg = Message.obtain(null, (st)?4:2);//STOP
                                      try {
        ...
        bindService(new Intent(this, FirstService.class), networkServiceConnection, 0/*Context.BIND_AUTO_CREATE*/);
    }
