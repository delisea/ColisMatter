...
install("reactive-dict");                                                                                              // 72
install("session");                                                                                                    // 73
install("bevanhunt:leaflet");                                                                                          // 74
install("ddp-rate-limiter");                                                                                           // 75
install("localstorage");                                                                                               // 76
install("callback-hook");                                                                                              // 77
...
install("email");                                                                                                      // 86
install("meteorhacks:ssr");                                                                                            // 87
install("webapp");                                                                                                     // 88
install("livedata");                                                                                                   // 89
install("hot-code-push");                                                                                              // 90
install("spacebars");                                                                                                  // 91
install("templating-compiler");                                                                                        // 92
install("templating-runtime");                                                                                         // 93
